...
class LatencyTracker:
    ...
    def max(self) -> float | None:
        ...
        Uses the current window (maxlen most-recent samples), NOT an all-time maximum.
        An all-time maximum would permanently inflate infer_delay after a slow warmup
        inference, causing RTC guidance to run with a nonsensical delay of 1000+ steps.
        """
