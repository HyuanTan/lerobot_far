...
benchmark_robot_type_path=so101 # so101_cs_update3

# ══ Method tag ════════════════════════════════════════════════════════════════
METHOD=async_rtc_inter # async_rtc_inter, async_rtc， async_rtc_imgcrop_compress， async_rtc_only_imgcrop
...
# ══ RTC settings ══════════════════════════════════════════════════════════════
RTC_HORIZON=16 # 20           # H (steps): rtc_execution_horizon
ACTIONS_PER_CHUNK=50     # K (fixed, must match server's chunk size)

chunk_size_threshold=0.4        # hardcoded; adjust when RTC_HORIZON changes
