#!/usr/bin/env bash
# eval-scripts/so101_smolvla/async_so101_smolvla_client-rtc-sm.sh
#
...
#
# ── Usage ─────────────────────────────────────────────────────────────────────
#   bash eval-scripts/so101_smolvla/async_so101_smolvla_client-rtc-sm.sh
#   SERVER_IP=192.168.1.100 bash eval-scripts/so101_smolvla/async_so101_smolvla_client-rtc-sm.sh
...
chunk_size_threshold=0.8        # hardcoded; adjust when RTC_HORIZON changes
